...
import com.portal.exceptions.vo.DetalhesErro;
...
public class PortalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(RuntimeException ex, WebRequest request) {
		...
		String mensagemUsuario = PortalExceptionMensagem.RECURSO_NAO_ENCONTRADO;
	...
	public ResponseEntity<Object> handleEmptyResultSuchMessageException(NoSuchMessageException ex, WebRequest request) {
		...
		// Carrega os dados do erro
		String mensagemUsuario = PortalExceptionMensagem.ARQUIVO_MENSAGEM_NAO_ENCONTRADO;
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex,
		...
		String mensagemUsuario = PortalExceptionMensagem.RECURSO_VIOLACAO_CHAVE;
